  ...
  return (
    <div className="col-md-4 px-0">
      <Card className="rounded-0" style={{ width: "100%" }}>
        <h2
          className="my-0 py-3 text-light text-center"
          style={{ backgroundColor: "#898262" }}
        >
          {service.title}
        </h2>
        <h1
          className="my-0 py-4 text-center text-light"
        ...
        <ListGroup className="text-center rounded-0">
          ...
          <ListGroup.Item className="even-color">
            {service.item2}
          </ListGroup.Item>
        ...
        <div className="py-3" style={{ backgroundColor: "#898262" }}>
          <button
            onClick={() => handelServices(service)}
            className="m-auto rounded py-2 border-0 d-block fs-4 text-light text-center"
            style={{ backgroundColor: "#212529", width: "40%" }}
          >
            Book Now
          </button>
        </div>
